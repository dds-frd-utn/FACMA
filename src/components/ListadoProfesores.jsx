    ...
    React.useEffect(() => {
        const obtenerDatos = async () => {
            try {
                ...
                const data = await db.collection('profesores').get()
                const arrayData = data.docs.map(doc => ({ id: doc.id, ...doc.data() }))
                setProfesores(arrayData);
            } catch (e) {
                console.log(e);
            }
        }
                ...
                <table className="table">
...

                    {
                        profesores.map(profesor => (
                            <tbody key={profesor.nombre}>
                                <tr className="align-middle">
                                    <td><img className="img-prof rounded-circle" src={profesor.foto} alt="imagen profesor" /></td>

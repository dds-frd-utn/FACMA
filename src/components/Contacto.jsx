...
const Contacto = () => {
    return (
        <div>
            <h1 className="text-center my-5">Formulario de contacto</h1>
            <div className="row">
                <div className="col">
                    <form>
                        <div className="mb-3">
                        ...
                        <h4>Asunto:</h4>
                        <select name="asunto" className="form-select" required>
                        ...
                        <textarea placeholder="Escriba el motivo de su consulta" className="form-control my-3" rows="10" required></textarea>
